...
- **Diagnostic Script Organization:** Moved standalone diagnostic and comparative analysis scripts (`compare.py`, `debug_*.py`, `get_checkov.py`, `scratch_repair.py`) into `scripts/debug/` to maintain clean repository layout and ensure coverage reporting accurately reflects core verifier engine code.
